...
class _Login implements LoginEvent {
  const _Login(this.requestModel);
...
class _Loaded implements LoginState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Loaded &&
            const DeepCollectionEquality().equals(other.Authe, Authe));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(Authe));

  @override
  String toString() {
    return 'LoginState.loaded(Authe: $Authe)';
  }
}
...
class __$LoadedCopyWithImpl<$Res> implements _$LoadedCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  $Res call({
    Object? Authe = freezed,
  }) {
    return _then(_Loaded(
      freezed == Authe
          ? _self.Authe
          : Authe // ignore: cast_nullable_to_non_nullable
              as dynamic,
    ));
  }
}
